...
<section id="cta" class="py-5 section-cta">
    <div class="container text-center">
        ...
        <div class="animate__animated animate__fadeInUp animate__delay-0-2s" data-animate>
            <a href="mailto:sigpau@sigpau.cat" class="btn btn-light btn-lg me-3 btn-glow">Enviar Mensaje</a>
            <a href="mailto:sigpau@sigpau.cat?subject=Solicitar%20Demo" class="btn btn-outline-light btn-lg">Solicitar Demo</a>
        </div>
    </div>
</section>
